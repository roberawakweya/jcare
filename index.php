                ...
                <div class="login-wrap">
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <form method="post">
                            <span class="badge badge-pill badge-danger"><?php echo htmlentities($_SESSION['errmsg']); ?><?php echo htmlentities($_SESSION['errmsg']="");?></span></span>
                            ...
                            <div class="register-link">
                                <p>
                                Copyright &copy; 2022 Jcare. All rights reserved.

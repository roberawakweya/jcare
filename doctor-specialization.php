...
<head>
    ...
    <!-- Title Page-->
    <title>Doctor Specialization | Hospital Management System</title>
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                            ...
                            <span class="badge badge-pill badge-success"><?php echo htmlentities($_SESSION['msg']);?>
                                ...
                                <form action="" method="post" class="form-horizontal">
                                    <div class="form-group">
                                        <label class=" form-control-label">Add Doctor Specialization</label>
                                        <input type="text" name="doctorspecilization" placeholder="Enter soctor specialization" class="form-control" required>
                                    </div>
                        ...
                        <!-- DATA TABLE -->
                        <h3 class="title-5 m-b-35">Manage Doctor Specialization</h3>
                                    ...
                                    <tr class="tr-shadow">
                                        ...
                                        <td>
                                            <div class="table-data-feature">
                                                <a href="edit-doctor-specialization.php?id=<?php echo $row['id'];?>" class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                    <i class="zmdi zmdi-edit"></i>
                                                </a>
                                                <a href="doctor-specialization.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" class="item" data-toggle="tooltip" data-placement="top" title="Delete">

...
<head>
    ...
    <!-- Title Page-->
    <title>Edit Doctor Specialization | Hospital Management System</title>
                    ...
                    <div class="container-fluid">
                        <div class="card">
                            ...
                            <span class="badge badge-pill badge-success"><?php echo htmlentities($_SESSION['msg']);?>
								<?php echo htmlentities($_SESSION['msg']="");?></p>	</span>
                                <form name="dcotorspcl" method="post" class="form-horizontal">
                                    <div class="form-group">
                                        <label class=" form-control-label">Update Doctor Specialization</label>
                                        <?php 
